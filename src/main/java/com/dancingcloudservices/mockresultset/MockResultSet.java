package com.dancingcloudservices.mockresultset;
...
public class MockResultSet implements ResultSet {
  ...
  public MockResultSet(String[][] initialData) {
    closed = false;
    rows = new ArrayList<String[]>(initialData.length + 10);
    currentRow = -1;
    for (int r = 0; r < initialData.length; r++) {
      rows.add(initialData[r].clone());
    }
  }
  
  @Override
  public boolean next() throws SQLException {
    if (closed) throw new SQLException("Result set is closed");
  ...
  public String getString(int columnIndex) throws SQLException {
    // JDBC Column indexes are one-based, not zero-based
    return rows.get(currentRow)[--columnIndex];
  }
